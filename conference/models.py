...
def create_default_roles_and_permissions(sender, instance, created, **kwargs):
    if created:
        default_permissions = [
            ...
            ('add_people', 'Add people to conference',
             'Can add new people/attendees to the conference'),
            ('edit_people_info', 'Edit people information',
             'Can edit people/attendees information'),
            ('change_status_people', 'Change people status',
             'Can change the status of people/attendees'),
            ('delete_people', 'Delete people from conference',
             'Can remove people/attendees from the conference'),
